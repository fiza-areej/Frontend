  ...
  render() {
    return (
      <section className={`${s.root} mb-4`} >
        <h1 data-aos="fade-up"
     data-aos-duration="2000" style={{color:"rgb(18, 20, 43)"}} className="page-title">UI - <span className="fw-semi-bold">Icons</span></h1>
     ...
     data-aos-duration="2000">Built-in <span className="fw-semi-bold">Glyphicons</span></h4>
